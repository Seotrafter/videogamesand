(() => {
    ...
    function addTouchClass() {
        if (isMobile.any()) document.documentElement.classList.add("_rujavn");
    }
    function addLoadedClass() {
        if (!document.documentElement.classList.contains("loading")) window.addEventListener("load", (function() {
            setTimeout((function() {
                document.documentElement.classList.add("_dwewsc");
            }), 0);
        }));
    }
    let bodyLockStatus = true;
    let bodyLockToggle = (delay = 500) => {
        if (document.documentElement.classList.contains("_kvbtmb")) bodyUnlock(delay); else bodyLock(delay);
    };
    let bodyUnlock = (delay = 500) => {
        if (bodyLockStatus) {
            ...
            setTimeout((() => {
                ...
                document.documentElement.classList.remove("_kvbtmb");
            }), delay);
    ...
    let bodyLock = (delay = 500) => {
        if (bodyLockStatus) {
            ...
            document.documentElement.classList.add("_kvbtmb");
            bodyLockStatus = false;
            setTimeout((function() {
                bodyLockStatus = true;
            }), delay);
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu")) {
                bodyLockToggle();
                document.documentElement.classList.toggle("_ppetld");
            }
        }));
    }
    ...
    function initSliders() {
        if (document.querySelector("._koipdx")) new swiper_core_Swiper("._koipdx", {
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        ...
        function updateProgress() {
            ...
            requestAnimationFrame((() => {
                ...
                progressBar.style.boxShadow = scrolled > 0 ? "0 2px 8px rgba(var(--color-primary-rgb), 0.4)" : "0 2px 4px rgba(0, 0, 0, 0.1)";
            }));
        }
